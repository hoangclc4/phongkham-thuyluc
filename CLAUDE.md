...
> Copy `CLAUDE.md` vào root của repo đang làm việc để dùng với Claude Code.
...
### 8. Commit & Scope Control
- Không được tự động commit bất kỳ thay đổi nào khi chưa hỏi và được user xác nhận rõ ràng.
- Trong lúc implement, nếu phát sinh nhu cầu thêm chức năng mới, refactor ngoài scope, hoặc chạy hành động có thể thay đổi trạng thái project, phải hỏi user trước khi thực hiện.
